...
type CustomerNotificationsFilters = {
  query?: string;
...
export async function listCustomerNotifications(
  ...
  filters: CustomerNotificationsFilters = {},
): Promise<CustomerNotificationsPayload> {
...
export async function getCustomerUnreadNotificationsCount(customerUserId: string) {
